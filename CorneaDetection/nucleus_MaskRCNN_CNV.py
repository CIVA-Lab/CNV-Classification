...
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "logs-cornea")

# Results directory
# Save submission files here
RESULTS_DIR = os.path.join(ROOT_DIR, "results/CNV_NEW/")
...
class NucleusDataset(utils.Dataset):
    ...
    def load_nucleus(self, dataset_dir, subset):
        ...
        self.add_class("cornea", 1, "cornea")
